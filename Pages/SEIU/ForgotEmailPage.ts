...
export class ForgotEmailPage extends BasePage{
    ...
    readonly resetPasswordSuccessfulMsg: Locator;
    ...
    constructor(page: Page) {
        ...
        this.resetPasswordSuccessfulMsg =  page.locator("//p[contains(text(),'We received your request to reset your password')]");
